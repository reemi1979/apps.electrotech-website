...
const QualityPhotos = () => {
    ...
    const photos = [
        ...
        { src: process.env.PUBLIC_URL + '/photos/quality/d.jpg', title: t('quality_photos_4_title'), category: t('quality_photos_4_category'), description: t('quality_photos_4_description') },
