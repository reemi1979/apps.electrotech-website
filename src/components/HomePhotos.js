...
const photos = [
    ...
    {
    src: process.env.PUBLIC_URL + '/photos/home/f.svg',
    title: t('home_photos_6_title'),
    category: t('home_photos_6_category'),
    description: t('home_photos_6_description')
    }
];
...
return (
    ...
    <AnimatePresence>
        ...
        >
            ...
            <Box sx={{ p: 3 }}>
                <Typography variant="caption" sx={{ textTransform: 'uppercase', color: theme.palette.text.primary }}>
                {selected.category}
                </Typography>
                <Typography variant="h5" fontWeight="bold" sx={{ mb: 2, color: theme.palette.text.primary }}>
                {selected.title}
                </Typography>
                <Typography variant="h6" sx={{ color: theme.palette.text.primary }}>{selected.description}</Typography>
            </Box>
            </MotionBox>
        </Box>
        </Modal>
